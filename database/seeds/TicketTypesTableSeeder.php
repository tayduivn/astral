...
class TicketTypesTableSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    $studentMultishow = new TicketType;
    ...
    $parentMultishow = new TicketType;
